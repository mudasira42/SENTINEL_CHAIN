...
# --- Twilio Config (Store securely using env vars in production) ---
TWILIO_SID = os.getenv("TWILIO_SID", "ACd9b73b6e815ea47c7f7d297940add61c")
TWILIO_TOKEN = os.getenv("TWILIO_TOKEN", "96b552b9b8b758177656faf05e5d998b")
TWILIO_FROM = os.getenv("TWILIO_FROM", "+12185177493")
ALERT_TO = os.getenv("ALERT_TO", "+917204321543")
